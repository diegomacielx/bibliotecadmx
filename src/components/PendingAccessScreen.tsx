  ...
  return (
    <div className="page-canvas min-h-screen flex items-center justify-center p-6 relative font-sans">
      <div className="auth-card p-8 sm:p-12 w-full max-w-md text-center animate-fade-in relative overflow-hidden z-10">
        ...
        <div className="pending-access-spinner mb-6 mx-auto relative z-10" aria-hidden="true">
          <svg viewBox="0 0 48 48" className="pending-access-spinner__svg">
            <circle
              className="pending-access-spinner__track"
              cx="24"
              cy="24"
              r="20"
              fill="none"
            ...
            />
            <circle
              className="pending-access-spinner__arc"
              cx="24"
              cy="24"
              r="20"
              fill="none"
